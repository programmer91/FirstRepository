 ...
 */
public class SoftwareVTO {
    
    /** Creates a new instance of SoftwareVTO */
    public SoftwareVTO() {
    }
    
    // parameters from check box.. start
    
    /* The int id is used for storing the Account Id */
    private long id;
