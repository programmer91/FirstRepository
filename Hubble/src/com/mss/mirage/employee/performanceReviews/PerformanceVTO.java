...
private String statusIdForTitle;
private String commentsForTitle;
  private String  metricNameForTitle;
 private String minValueForTitle;
   private String maxValueForTitle;
...
private String commentsForPerformance;
    ...
    public String getStatusIdForTitle() {
        return statusIdForTitle;
    }

    public void setStatusIdForTitle(String statusIdForTitle) {
        this.statusIdForTitle = statusIdForTitle;
    }

    public String getCommentsForTitle() {
        return commentsForTitle;
    }

    public void setCommentsForTitle(String commentsForTitle) {
        this.commentsForTitle = commentsForTitle;
    }

    public String getMaxValueForTitle() {
        return maxValueForTitle;
    }

    public void setMaxValueForTitle(String maxValueForTitle) {
        this.maxValueForTitle = maxValueForTitle;
    }

    public String getMetricNameForTitle() {
        return metricNameForTitle;
    }

    public void setMetricNameForTitle(String metricNameForTitle) {
        this.metricNameForTitle = metricNameForTitle;
    }

    public String getMinValueForTitle() {
        return minValueForTitle;
    }

    public void setMinValueForTitle(String minValueForTitle) {
