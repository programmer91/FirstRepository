...
function disableStart(){
 ...
 <!--//START MAIN TABLE : Table for template Structure-->
        ...
        <table class="templateTable1000x580" align="center" cellpadding="0" cellspacing="0">
           ...
           <tr class="headerBg">
                <td valign="top">
                    <s:if test="%{examStatus=='FAIL' || isLastExam=='YES'}">
                    <s:include value="/includes/template/CreHeader.jsp"/>   
                    </s:if>
                    <s:else>
                        <s:include value="/includes/template/CreHeader_1.jsp"/>   
                    </s:else>
                </td>
            </tr>
                                                                ...
                                                                <tr>
                                                                    <td colspan="4">
                                                                        ...
                                                                        <h3 class="bgColor" align="center">
                                                                         <script type="text/JavaScript" src="<s:url value="/includes/javascripts/cre/creResult.js"/>"></script>
                                                                        </h3>
                                                                    </td>
                                                                </tr>  
                                                                    ...
                                                                    <td>
                                                                      <%-- Exam Result data Start --%>  
                                                                        <table>
                                                                            ...
                                                                            <s:if test="%{examStatus=='PASS' && isLastExam=='NO'}">
                                                                                  <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <%-- <b id="loadMsg" style="display: none;" class="error" ><font color="red">Loading Please wait....</font></b> --%>
                                                                            ...
                                                                            </s:if><s:elseif test="%{examStatus=='PASS' && isLastExam=='YES'}">
                                                                                  <tr>
...
$(document).ready(function() {
   getChart(document.getElementById('totalQuest'),document.getElementById('examMarks'),document.getElementById('eStatus'));
     });
</script>	
    </body>
