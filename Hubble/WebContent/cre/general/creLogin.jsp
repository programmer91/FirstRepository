                ...
                <td align="center">
                    <table border="0" width="350px;" cellpadding="2" cellspacing="2">
                        <tr>
                            <tr>
                                <td>
                                <s:form action="../general/creLoginCheck.action" method="post" name="consultantLoginForm" id="consultantLoginForm" theme="simple" onsubmit="return checkCreLoginForm();"> 
                                   <%--  <s:form action="/general/loginCheck.action" method="post" name="userLoginForm" id="userLoginForm" theme="simple" onsubmit="return popUp();"> --%>
                                        ...
                                        <table id="login" bgcolor="#ffffff" border="0" height="150px" width="340px;" align="left" cellpadding="0" cellspacing="2" class="border">
                                            <head >
                                                ...
                                                <font color="#336699" size="2px"><b>Consultant Login</b></font></th>
                                            </head>
                                            <tr> 
                                                <td colspan="2">
                                                    <s:actionerror/>
...
$(document).ready(function() {
    document.consultantLoginForm.consultantId.focus();
     });
</script>
    </body>
</html>
