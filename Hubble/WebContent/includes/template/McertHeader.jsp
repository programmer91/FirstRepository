...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        ...
        <td width="595px" align="center" class="userInfo">
             ...
             <s:if test="#session.sesConsultantName != null ">
         ...
         <td width="360px" align="center" valign="bottom">
             <!-- Cre Login start-->
              <s:if test="#session.userId == null ">
                <a class="menuBarLogInLink" href="<s:url value="mcertlogin.action"/>">
                    <img alt="Home" 
       ...
       <s:if test=" #session.userId != null">
               <a class="menuBarLogoutLink" href="<s:url value="mcertlogout.action"/>">
                    <img alt="Logout" 
                         src="<s:url value="/includes/images/spacer.gif"/>" 
                         width="59px" 
                         height="13px" border="0">
