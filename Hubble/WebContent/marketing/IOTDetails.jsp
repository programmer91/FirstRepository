<%-- 
    Document   : IOTDetails
    Created on : Feb 4, 2016, 11:05:14 PM
    Author     : miracle
--%>
...
<html>
    <head>
        ...
        <script>
            function getIOTDetailsExcelSheet(){
...
%>
                                ...
                                <ul id="accountTabs" class="shadetabs" >
                                    ...
                                    <li ><a href="#" class="selected" rel="issuesTab">IOT&nbsp;Data</a></li>
                                ...
                                <div  style="border:1px solid gray; width:845px;height: 500px; overflow:auto; margin-bottom: 1em;">
                                    ...
                                    <div id="issuesTab" class="tabcontent" >
                                                ...
                                                <table align="center" border="0" cellspacing="0" style="width:100%;">
                                                    ...
                                                    <tr><td colspan="4">
                                                            <table style="width:80%;" align="center">
                                                                ...
                                                                <tr>
                                                                    <td class="fieldLabel" >Zip&nbsp;Code:<FONT color="red"  ><em>*</em></FONT> </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <%--<td ><s:textfield name="description:" id="description:" cssClass="inputTextBlue" /></td> --%>
                                                                    <td colspan="6"><s:textarea rows="3" cols="120" style='width: 565px; height: 45px;' name="description:" cssClass="inputTextarea1"   id="description:"/>
                                                                </tr>
                                        ...
                                        <s:form action="searchIOTDetails.action" name="frmDBGrid" id="frmDBGrid" theme="simple"> 
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table border="0" cellpadding="0" cellspacing="2" align="left" width="100%">
                                                                ...
                                                                <s:hidden id="tableName" name="tableName" value="tblIot"/>
                                                                <tr>
                                                                    <td class="fieldLabel">Name:</td>
                                                                    <td > <s:textfield name="iotNameSearch"  id="iotNameSearch" cssClass="inputTextBlue" /></td>
                                                                    <td class="fieldLabel">Zip&nbsp;Code:</td>
                                                                    <td > <s:textfield name="iotZipCodeSearch"  id="iotZipCodeSearch" cssClass="inputTextBlue" /></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center" colspan="4" style="padding-left: 460px;">
                                                                        ...
                                                                        <s:if test="#session.websiteInfoList != null"> 
                                                                            ...
                                                                            <input type="button" name="generateExcel" id="generateExcel" class="buttonBg" value="Generate Excel"  onclick="return getIOTDetailsExcelSheet();"/>
                                                                            <% }%>
                                                                        </s:if>
                                                                    </td>
                                                                </tr> 
                                                                    ...
                                                                    <tr CLASS="gridRowEven">
                                                                        ...
                                                                        <td class="title">
                                                                            ...
                                                                            <%
                                                                                ...
                                                                                out.println(subList.get("City"));


                                                                            %>
                                                                        </td>   <td class="title">
                                                                            <%
                                                                                out.println(subList.get("ZipCode"));
