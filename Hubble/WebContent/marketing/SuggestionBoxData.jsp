<%-- 
    Document   : SuggestionBoxData
    Created on : Jul 29, 2015, 4:25:53 PM
    Author     : miracle
--%>
...
<html>
    <head>
        ...
        <title>Hubble Organization Portal :: Suggestion Box</title>
   ...
   <script type="text/JavaScript" src="<s:url value="/includes/javascripts/marketing/EventsPosting.js"/>"></script>  
        <script>
       function getSuggestionBoxDataExcelSheet(){
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:5px 5px ;">
                                ...
                                <%--    <% if(request.getParameter("issueList")==null)
                                       {%> --%>
                                        ...
                                        <li ><a href="#" class="selected" rel="issuesTab">Suggestion&nbsp;Box&nbsp;Data</a></li>
                                                    ...
                                                    <td colspan="4">
                                                        ...
                                                        <tr><td colspan="4">
                                                         <table style="width:80%;" align="center">
                                                           ...
                                                           <tr>
                                                                <td class="fieldLabel" >Posted anonymously:<FONT color="red"  ><em>*</em></FONT> </td>
                                                                <td colspan="5"><span id="postedAnonymously:"></span></td>
                                                           </tr>
                                                           <tr style="display: none;" id="nameTr">
                                                     ...
                                                     <td ><s:textfield name="firstName" id="firstName" cssClass="inputTextBlue" /></td>
                                                        ...
                                                        <td colspan="3"><s:textfield name="lastName" id="lastName" cssClass="inputTextBlue" /></td>
                                                     
                                                   
                                                       </tr>   
                                                              <tr>
                                                 <td class="fieldLabel" valign="top">Suggestions :<FONT color="red"  ><em>*</em></FONT></td>
                                                     <td colspan="5" valign="top"><s:textarea rows="5" cols="65" name="suggestions" cssClass="inputTextareaOverlay1" id="suggestions" />
                                                       </tr> 
                                                     ...
                                                     <td ><span id="createdDate"></span></td>
                                                           ...
                                                           <s:form action="searchSuggestionBox.action" name="frmDBGrid" id="frmDBGrid" theme="simple" onsubmit="return checkMandatory();"> 
                 ...
                 <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="2" align="left" width="100%">
                                ...
                                <s:hidden id="tableName" name="tableName" value="tblSuggestions"/>
                               <tr>
                                ...
                                <tr>
                                  ...
                                  <%java.util.List mainListt = (java.util.List) session.getAttribute("websiteInfoList");
                                                                    ...
                                                                    <td colsapn="1" align="left"><input type="button" name="generateExcel" id="generateExcel" class="buttonBg" value="Generate Excel"  onclick="return getSuggestionBoxDataExcelSheet();"/></td>
                                                                    <% } %>
                                    </s:if>
                                </tr>
                            </table>
