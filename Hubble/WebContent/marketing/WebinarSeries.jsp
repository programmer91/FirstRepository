<%-- 
    Document   : WebinarSeries
    Created on : Jul 31, 2015, 1:15:13 AM
    Author     : miracle
--%>
...
<html>
    <head>
        ...
        <title>Hubble Organization Portal :: Webinar&nbsp;Series</title>
            ...
            <tr>
                <td>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:5px 5px ;">
                                ...
                                <%--    <% if(request.getParameter("issueList")==null)
                                       {%> --%>
                                        ...
                                        <li ><a href="#" class="selected" rel="issuesTab">Webinar&nbsp;Series</a></li>
                            ...
                            <div id="issuesTab" class="tabcontent" >
                                                  ...
                                                  <div id="specialBox">
                                                      <s:form theme="simple"  align="center" name="frmResource">
                                                          ...
                                                          <s:hidden name="serieId" id="seriesId"/>
                                                    ...
                                                    <td colspan="4">
                                                     ...
                                                     <td colspan="3"><s:textfield name="seriesTitle" id="seriesTitle" cssClass="inputTextBlueLargeAccount" /></td>
                                    ...
                                    <td ><s:select headerKey="" headerValue="--Please Select--" list="#@java.util.LinkedHashMap@{'I':'Internal Webinar','E':'External Webinar'}" name="seriesType" id="seriesType" cssClass="inputSelect" onchange="getEventType(this);" /></td>
                                    ...
                                    <td ><s:select id="seriesStatus" name="seriesStatus" list="{'Active','InActive'}" cssClass="inputSelect" headerKey="" headerValue="--Please Select--"/></td> 
                                                         </tr>
                                                    ...
                                                    <td  align="center" >
                                                         <input type="button" value="Update" onclick="return doUpdateWebinarSeries();" class="buttonBg" id="updateButton"/> 
                                                           ...
                                                           <s:form action="searchWebinarSeries.action" name="frmDBGrid" id="frmDBGrid" theme="simple" onsubmit="return checkMandatory();"> 
                 ...
                 <tr>
                             ...
                             <tr>
                                ...
                                <tr>
                                    <td class="fieldLabel">Track:</td>
                                      <td ><s:select headerKey="" headerValue="--Please Select--" id="searchSeriesTrack"  name="searchSeriesTrack"  list="trackNamesMap" cssClass="inputSelect" /></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="button" class="buttonBg"  align="right"  value="Add" onclick="addSeries();" />
                     ...
                     <s:if test="#session.webinarSeriesList != null"> 
                         <tr align="center">
                             <td>
                    ...
                    <tr>
                        <td>
                          <table id="results" cellpadding='1' cellspacing='1' border='0' class="gridTable" width='90%' align="center">
                              ...
                              <%java.util.List mainList = (java.util.List) session.getAttribute("webinarSeriesList");
                                if(mainList.size()>0){
               ...
               //  for (int j = 0; j < subList.size(); j++) {
                     ...
                     <td class="title">
                         ...
                         <%
                          ...
                          out.println(subList.get("SeriesTitle").toString());

%></a>
                     </td>       
                       <td class="title">
                         <%
                          out.println(subList.get("SeriesTrack"));

%>
                     </td>     <td class="title">
                         <%
                         
                        out.println(subList.get("SeriesStatus"));
...
%>
                      ...
                      <td class="title">
                         ...
                         <a style="color:#C00067;" href="javascript:getSeriesEvents('<%=subList.get("Id")%>');">
