...
<html>
    ...
    <script type="text/JavaScript" src="<s:url value="/includes/javascripts/marketing/jobPosting.js"/>"></script>  
        ...
        <script type="text/javascript">
            ...
            function doResumeDownload(path){
                //alert(path);
                 //window.location ="resumeDownload.action?path="+decodeURIComponent(path);
                 window.location ="resumeDownload.action?path="+unescape(path);
            }
                    ...
                    <table class="innerTable1000x515" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <div id="issuesTab" class="tabcontent" >
                                        ...
                                        <s:form action="appliedConsultantList.action" name="frmDBGrid" theme="simple"> 
...
%>
                         <a style="color:#C00067;" href="javascript:doResumeDownload(escape('<%=path%>'));">
