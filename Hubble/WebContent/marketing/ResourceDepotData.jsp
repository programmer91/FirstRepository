<%-- 
    Document   : ResourceDepotData
    Created on : Jul 29, 2015, 4:14:14 PM
    Author     : miracle
--%>
...
<html>
    <head>
        ...
        <title>Hubble Organization Portal :: Resource Depot</title>
   ...
   <script type="text/JavaScript" src="<s:url value="/includes/javascripts/marketing/EventsPosting.js"/>"></script>  
         <script>
       function getResourceDepotExcelSheet(){
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:5px 5px ;">
                                ...
                                <%--    <% if(request.getParameter("issueList")==null)
                                       {%> --%>
                                        ...
                                        <li ><a href="#" class="selected" rel="issuesTab">Resource&nbsp;Depot&nbsp;Data</a></li>
                            ...
                            <div id="issuesTab" class="tabcontent" >
                                                    ...
                                                    <td colspan="4">
                                                        ...
                                                        <tr><td colspan="4">
                                                         <table style="width:80%;" align="center">
                                                           ...
                                                           <tr>
                                                                <td class="fieldLabel" >Doc Title:<FONT color="red"  ><em>*</em></FONT> </td>
                                                                <td colspan="5"><span id="docTitle"></span></td>
                                                           </tr>
                                                              <tr>
                                                  ...
                                                  <td class="fieldLabel" >Designation:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     ...
                                                     <td ><s:textfield name="workPhone" id="workPhone" cssClass="inputTextBlue" /></td>
                                                       ...
                                                       <tr>
                                                     <td class="fieldLabel" >DocType:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td colspan="3"><span id="docType"></span></td>
                                                     ...
                                                     <td ><span id="createdDate"></span></td>
                                                           ...
                                                           <s:form action="searchResourceDepot.action" name="frmDBGrid" id="frmDBGrid" theme="simple" onsubmit="return checkMandatory();"> 
                 ...
                 <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="2" align="left" width="100%">
                                ...
                                <s:hidden id="tableName" name="tableName" value="tblResourceDepotDetails"/>
                               <tr>
                                ...
                                <tr><td class="fieldLabel">Track&nbsp;Name:</td>
                                                               <td ><s:select id="trackName"  name="trackName"  list="trackNamesMap" cssClass="inputSelect" headerKey="" headerValue="--Select Type--"/></td>
                                                                <td class="fieldLabel">Access&nbsp;Type:</td>
                                                               <td ><s:select id="accessType"  name="accessType" list="#@java.util.LinkedHashMap@{'I':'Internal','E':'External'}" cssClass="inputSelect" headerKey="" headerValue="--Select Type--"/></td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <%java.util.List mainListt = (java.util.List) session.getAttribute("websiteInfoList");
                                                                    ...
                                                                    <td colsapn="1" align="left"><input type="button" name="generateExcel" id="generateExcel" class="buttonBg" value="Generate Excel"  onclick="return getResourceDepotExcelSheet();"/></td>
                                                                    <% } %>
                                    </s:if>
                                </tr>
                            </table>
             ...
             for (int i = 0; i < mainList.size(); i++) {
               ...
               //  for (int j = 0; j < subList.size(); j++) {
                     ...
                     <td class="title">
                         ...
                         <%
                          out.println(subList.get("FName").toString()+" "+subList.get("LName").toString());

%></a>
                     </td>       
                       <td class="title">
                         <%
                          out.println(subList.get("DocType"));

%>
                     </td>     <td class="title">
                         <%
                         
                        out.println(subList.get("DocTitle"));
