...
<html>
   ...
   <script type="text/JavaScript" src="<s:url value="/includes/javascripts/marketing/EventsPosting.js"/>"></script>  
       ...
       function getQmeetAttendiesExcelSheet(){
                ...
                window.location="getQmeetAttendiesExcelSheet.action";
                            ...
                            <div id="issuesTab" class="tabcontent" >
                                                  ...
                                                  <div id="specialBox">
                                                    ...
                                                    <td colspan="2" style="background-color: #288AD1" align="right">
                                                        ...
                                                        <a href="#" onmousedown="closeQmeetAttendeeOverlay()" >
                                                  ...
                                                  <td class="fieldLabel" >Department:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     ...
                                                     <td ><span id="createdDate"></span></td>
                                                           ...
                                                           <s:form action="getQmeetAttendees.action" name="frmDBGrid" id="frmDBGrid" theme="simple"> 
                            ...
                            <table border="0" cellpadding="0" cellspacing="2" align="left" width="100%">
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <s:if test="#session.qmeetAttendeesList != null"> 
                                  <%java.util.List mainList1 = (java.util.List) session.getAttribute("qmeetAttendeesList");
                                                                        if (mainList1.size() > 0) {
                    ...
                    <tr>
                        <td>
                          <table id="results" cellpadding='1' cellspacing='1' border='0' class="gridTable" width='90%' align="center">
                              ...
                              <%java.util.List mainList = (java.util.List) session.getAttribute("qmeetAttendeesList");
                                if(mainList.size()>0){
      ...
      <tr class="gridHeader">
             ...
             for (int i = 0; i < mainList.size(); i++) {
               ...
               //  for (int j = 0; j < subList.size(); j++) {
                     ...
                     <td class="title">
                         <a style="color:#C00067;" href="javascript:getQmeetAttendeeDetails(<%=subList.get("Id")%>);">
                         <%
