                    ...
                    <table class="innerTable1000x515" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <div id="issuesTab" class="tabcontent" >
                                                           ...
                                                           <s:form action="addWebinarToSeries" name="frmDBGrid" id="frmDBGrid" theme="simple" onsubmit="return checkSeriesEventMandatory();"> 
...
%>
                      ...
                      <td class="title">
                         ...
                         <a style="color:#C00067;" href="javascript:removeWebinarsFromSeries('<%=subList.get("event_id")%>','<%=subList.get("SeriesId")%>');">
