<%-- 
    ...
    Created on : Jul 29, 2015, 3:54:05 PM
    Author     : miracle
--%>
...
<html>
    <head>
        ...
        <title>Hubble Organization Portal :: Contact Us</title>
  ...
  <script>
       function getContactUsExcelSheet(){
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:5px 5px ;">
                                ...
                                <%--    <% if(request.getParameter("issueList")==null)
                                       {%> --%>
                                        ...
                                        <li ><a href="#" class="selected" rel="issuesTab">ContactUs&nbsp;Data</a></li>
                            ...
                            <div id="issuesTab" class="tabcontent" >
                                                  ...
                                                  <div id="specialBox">
                                                    ...
                                                    <td colspan="4">
                                                     ...
                                                     <td ><s:textfield name="city" id="city" cssClass="inputTextBlue" /></td>
                                                        <td class="fieldLabel" >State:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><s:textfield name="state" id="state" cssClass="inputTextBlue" /></td>
                                                        <td class="fieldLabel" >Country:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><s:textfield name="country" id="country" cssClass="inputTextBlue" /></td>
                                                       </tr>
                                                       <tr>
                                                             <td class="fieldLabel" >Zip:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><s:textfield name="zip" id="zip" cssClass="inputTextBlue" /></td>
                                                     <td class="fieldLabel" >Created date:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><span id="createdDate"></span></td>
                                                       </tr>
                                                       <tr>
                                                           <td class="fieldLabel" valign="top">Comments:<FONT color="red"  ><em>*</em></FONT></td>
                                                     <td colspan="3" valign="top"><s:textarea rows="5" cols="65" name="comments" cssClass="inputTextareaOverlay1" id="comments" />
                                                           ...
                                                           <s:form action="searchContactUsData.action" name="frmDBGrid" id="frmDBGrid" theme="simple" onsubmit="return checkMandatory();"> 
                 ...
                 <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="2" align="left" width="100%">
                                ...
                                <s:hidden id="tableName" name="tableName" value="tblContactus"/>
                               <tr>
                                ...
                                <tr>
                                  ...
                                  <%java.util.List mainListt = (java.util.List) session.getAttribute("websiteInfoList");
                                                                    ...
                                                                    <td colsapn="1" align="left"><input type="button" name="generateExcel" id="generateExcel" class="buttonBg" value="Generate Excel"  onclick="return getContactUsExcelSheet();"/></td>
                                                                    <% } %>
                                    </s:if>
                                </tr>
                            </table>
