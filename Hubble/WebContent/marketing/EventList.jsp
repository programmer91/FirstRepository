            ...
            <tr>
                <td>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:5px 5px ;">
                                ...
                                <%--    <% if(request.getParameter("issueList")==null)
                                       {%> --%>
                                        ...
                                        <li ><a href="#" class="selected" rel="issuesTab">Upcoming&nbsp;Events&nbsp;List</a></li>
                            ...
                            <div id="issuesTab" class="tabcontent" >
                                                  ...
                                                  <div id="specialBox" >
                                                        ...
                                                        <tr><td colspan="0">
                                                         <table style="width:80%;" align="center">
                                                           ...
                                                           <%-- <td ><s:select id="eventStatus"  name="eventStatus"  list="{'Active','InActive','Completed'}" cssClass="inputSelect" onchange="getVideoTr(this);"/> --%>
                                                            <td ><s:select id="eventStatus"  name="eventStatus"  list="{'Active','InActive'}" cssClass="inputSelect" onchange="getVideoTr(this);"/>
                                                     </td>
                                                                     </tr>
                                                    ...
                                                    <td><s:select id="endTime"  name="endTime"  list="timeList" cssClass="inputSelectGender" /><s:select id="midDayTo"  name="midDayTo"  list="{'AM','PM'}" cssClass="inputSelectSmall" />
                                                     ...
                                                     <td class="fieldLabel"><div id="timeZoneLabelId" style="display: none">Select&nbsp;TimeZone:</div></td>  
                                                        <td ><div id="timeZoneTextId" style="display: none"><s:select id="timeZone"  name="timeZone"  list="{'EST','IST','MST','CST','PST'}" cssClass="inputSelect" /></div></td>
                                                     ...
                                                     <td colspan="3" valign="top"><s:textarea rows="5" cols="65" name="eventDescription" cssClass="inputTextareaOverlay1" onchange="checkDoubleQuotes(this);return fieldLengthValidator2(this);" id="eventDescription" />
                                                     ...
                                                     <td colspan="3">
                                                          <s:textfield name="eventRegistrationLink" id="eventRegistrationLink" cssClass="inputTextBlueLargeAccount" onchange="isUrl(this);return fieldLengthValidator2(this);" />
                                                     </td> 
                                                     </tr>
                                                     ...
                                                     <td colspan="3">
                                                          <s:textfield name="conferenceUrl" id="conferenceUrl" cssClass="inputTextBlueLargeAccount" onchange="isUrl(this);return fieldLengthValidator2(this);" />
                                                     </td> 
                                                     </tr>
                                                     ...
                                                     <tr style="display: none" id="eventDepartmentTr">
                                                         ...
                                                         <td colspan="3"><s:select headerKey="" headerValue="--Please Select--" id="eventDepartment"  name="eventDepartment"  list="{'Business Development','Marketing','Recruitment','Other','Development','Operations'}" cssClass="inputSelect" /></td>
                                                     </tr>
                                                     ...
                                                     <td colspan="3">
                                                          <s:textfield name="eventAfterVideoUrl" id="eventAfterVideoUrl" cssClass="inputTextBlueLargeAccount" onchange="isUrl(this);return fieldLengthValidator2(this);" />
                                                     </td> 
                                                     </tr>
                               ...
                               <td ><s:select id="associatedEventId"  name="associatedEventId"  list="associatedEventMap" headerKey="" headerValue="--Please Select--" cssClass="inputSelect"/></td> 
                                                    ...
                                                    <td  align="center" >
                                                         <input type="button" value="Update" onclick="return doUpdateEventPost();" class="buttonBg" id="updateButton"/> 
                                                    </td>
                                                </tr>
                                                               </table>
                                                           </td>
                                        ...
                                        <s:form action="webEventSearch.action" id="frmDBGrid" name="frmDBGrid" theme="simple"> 
                    ...
                    <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="2" align="left" width="100%">
                                ...
                                <%--    <td ><s:select headerKey="" headerValue="--Please Select--" id="status"  name="status"  list="{'Active','InActive'}" cssClass="inputSelect"  disabled="False"/> --%>
                                    <td ><s:select  id="status"  name="status"  list="{'Active','InActive'}" cssClass="inputSelect"  disabled="False"/>
                                </tr>
                                <tr>
                     ...
                     <s:if test="#session.eventslist != null"> 
                    <tr>
                        <td>
                          <table id="results" cellpadding='1' cellspacing='1' border='0' class="gridTable" width='90%' align="center">
                               
                              <%java.util.List mainList = (java.util.List) session.getAttribute("eventslist");
                                if(mainList.size()>0){
             ...
             for (int i = 0; i < mainList.size(); i++) {
               ...
               //  for (int j = 0; j < subList.size(); j++) {
                     ...
                     <td class="title">
                         ...
                         <a style="color:#C00067;" href="javascript:editEventPost('<%=subList.get("event_id")%>');">
                         <%
...
%>
    ...
    %>
                       <%--  <a style="color:#C00067;" href="javascript:getEventSpeakers('<%=subList.get("event_id")%>');">
                             <img src="../includes/images/go_21x21.gif"/>
                        </a> --%>
                        <a style="color:#C00067;" href="javascript:getEventSpeakers('<%=subList.get("event_id")%>','EV');">
                             <img src="../includes/images/go_21x21.gif"/>
                        </a>
                             <% } %>
                     </td>
