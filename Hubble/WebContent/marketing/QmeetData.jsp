<%-- 
    Document   : QmeetData
    Created on : Jul 29, 2015, 4:36:14 PM
    Author     : miracle
--%>
...
<html>
    <head>
        ...
        <title>Hubble Organization Portal :: Quarterly Meet</title>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:5px 5px ;">
                                ...
                                <%--    <% if(request.getParameter("issueList")==null)
                                       {%> --%>
                                        ...
                                        <li ><a href="#" class="selected" rel="issuesTab">Quarterly&nbsp;Meet&nbsp;Data</a></li>
                            ...
                            <div id="issuesTab" class="tabcontent" >
                                                    ...
                                                    <td colspan="4">
                                                        ...
                                                        <tr><td colspan="4">
                                                         <table style="width:80%;" align="center">
                                                              ...
                                                              <tr>
                                                     <td class="fieldLabel" >Full Name:<FONT color="red"  ><em>*</em></FONT> </td>
                                                  ...
                                                  <td class="fieldLabel" >Department:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><s:textfield name="department" id="department" cssClass="inputTextBlue" /></td>
                                                        <td class="fieldLabel" >Food Preference:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><s:textfield name="foodPreference" id="foodPreference" cssClass="inputTextBlue" /></td>
                                                        <td class="fieldLabel" >Corporate&nbsp;Transport:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><s:textfield name="corporateTransport" id="corporateTransport" cssClass="inputTextBlue" /></td>
                                                       </tr> 
                                                       
                                                       <tr>
                                                     <td class="fieldLabel" >Drop Point:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><s:textfield name="dropPoint" id="dropPoint" cssClass="inputTextBlue" /></td>
                                                        <td class="fieldLabel" >Bringing anyone along?:<FONT color="red"  ><em>*</em></FONT> </td>
                                                     <td ><s:textfield name="bringingAlong" id="bringingAlong" cssClass="inputTextBlue" /></td>
                                                     ...
                                                     <td ><span id="createdDate"></span></td>
                                                           ...
                                                           <s:form action="searchQuarterlyMeet.action" name="frmDBGrid" id="frmDBGrid" theme="simple" onsubmit="return checkMandatory();"> 
                 ...
                 <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="2" align="left" width="100%">
                                ...
                                <s:hidden id="tableName" name="tableName" value="tblEventAttendies"/>
                                
                                
                                
                                <tr>
                                    <td class="fieldLabel">Year:</td>
                                    <td ><s:select id="qmeetYear"  name="qmeetYear"  list="{'2015','2016','2017','2018','2019','2020'}" cssClass="inputSelect" onchange="getQmeetList(this);"/></td>
                                    <td class="fieldLabel">Qmeet:</td>
                               <td ><s:select id="qmeetTitleId"  name="qmeetTitleId"  list="qmeetMap" headerKey="" headerValue="--Please Select--" cssClass="inputSelect"/></td> 
                                </tr>
                               ...
                               <tr>
                                ...
                                <tr>
                                  ...
                                  <%java.util.List mainList1 = (java.util.List) session.getAttribute("websiteInfoList");
                                                                        if (mainList1.size() > 0) {


                                                                    %>
                                                                    
                                                                    <td colsapn="1" align="left"><input type="button" name="generateExcel" id="generateExcel" class="buttonBg" value="Generate Excel"  onclick="return getQmeetAttendiesExcelSheet();"/></td>
                                                                    <% } %>
                                    </s:if>
                                </tr>
                            </table>
               ...
               //  for (int j = 0; j < subList.size(); j++) {
                     ...
                     <td class="title">
                         ...
                         <%
                          ...
                          out.println(subList.get("firstname").toString());

%></a>
                     </td>       
                       <td class="title">
                         <%
                          out.println(subList.get("EventName"));

%>
                     </td>     <td class="title">
                         <%
                         
                        out.println(subList.get("phone_no"));
                                              

%>
                     </td>     <td class="title">
                         <%
                        out.println(subList.get("department"));
