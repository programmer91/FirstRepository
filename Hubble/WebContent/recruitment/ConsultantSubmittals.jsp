 ...
 * Project : Mirage V2
 *
 * Package :com.mss.mirage.recruitment.consultantsubmittals
 *
...
<html>
    <head>
        ...
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/recruitment/ConsultantSubmittalsClientValidation.js"/>"></script>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding-left:10px;padding-top:5px;">
                               ...
                               <%-- <a class="navigationText" href="<s:url action="consultant/getConsultant"><s:param name="consultantId" value="%{empId}"/></s:url>"><%=fname%>.<%=lname%></a> --%>
                                ...
                                <ul id="resumeAttachmentDetailsTabs" class="shadetabs" >
                                    <li ><a href="#" class="selected" rel="resumeSubmittalTab"  > Resume Submittal Details </a></li>                                    
                                </ul>
                                ...
                                <!--//START TAB : -->
                                <%-- <sx:div id="resumeSubmittalTab" label="Resume Submittal Details"  > --%>
                                    
                                <div  style="border:1px solid gray; width:840px;height: 500px; overflow:auto; margin-bottom: 1em;">
                                    
                                    <div id="resumeSubmittalTab" class="tabcontent"  >
                                        <s:form name="frmsubmitt" action="insertResumeSubmitt" theme="simple" method="POST" enctype="multipart/form-data" onsubmit="return checkManadatory();">
                                            ...
                                            <s:hidden name="requestType" value="S"/>
                                            ...
                                            <table cellpadding="2" cellspacing="0" border="0" width="100%">                                                
                                                ...
                                                <tr> 
                                                    <td class="fieldLabel">Submitt Resume Name :<font style="color:red;">*</font></td>
                                                    <td><s:textfield name="attachmentName" id="attachmentName" cssClass="inputTextarea" onchange="attachmentNameValidate();" /></td> 
                                                    
                                                    <td class="fieldLabel">Submitt Resume :<font style="color:red;">*</font></td>
