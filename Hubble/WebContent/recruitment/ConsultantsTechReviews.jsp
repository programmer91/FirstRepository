                        ...
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding-left:10px;padding-top:5px;">
                               ...
                               <ul id="consultantTechReviewDetailsTabs" class="shadetabs" >
                                    <li ><a href="#" class="selected" rel="consultantTechReviewTab"  > Consultant Tech Reviews </a></li>                                    
                                </ul>
                                ...
                                <div  style="border:1px solid gray; width:840px;height: 500px; overflow:auto; margin-bottom: 1em;">   
                                    ...
                                    <div id="consultantTechReviewTab" class="tabcontent"  >
                                        <s:form name="frmAttach" action="insertTechreview" theme="simple" method="POST" enctype="multipart/form-data" onsubmit="return checkManadatory();">
                                            ...
                                            <s:hidden name="requestType" value="T"/>
                                            ...
                                            <table cellpadding="2" cellspacing="0" border="0" width="100%">                                                
                                                ...
                                                <tr> 
                                                    <td class="fieldLabel">TechReview File Name :<font style="color:red;">*</font></td>
                                                    <td><s:textfield name="attachmentName" id="attachmentName" cssClass="inputTextarea" onchange="return attachmentNameValidate();"/></td> 
                                                    
                                                    <td class="fieldLabel">TechReview File :<font style="color:red;">*</font></td>
