...
<html>
    <head>
      ...
      /*      function checkValidationForActivityDates(){
               var   activityFromDate= document.getElementById('activityFromDate1').value;
               var activityToDate=document.getElementById('activityToDate').value;
               if(activityFromDate==''){
                    alert("activityFromDate is mandatory");
                return false;   
               }
               
                 
                if(activityToDate != "" && activityToDate != null){
                   var mm = activityFromDate.substring(0,2);
                var dd = activityFromDate.substring(3,5);
                var yyyy = activityFromDate.substring(6,10);
                var mm1 = activityToDate.substring(0,2);
                var dd1 = activityToDate.substring(3,5);
                var yyyy1 = activityToDate.substring(6,10);
                        ...
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top"  style="padding-left:10px;padding-top:5px;">
                                ...
                                <ul id="ConsultantSearchTabs" class="shadetabs" >
                                    ...
                                    <li ><a href="#" rel="consultantSearchTab">Untouched Consultants Search </a></li>
                                    <li><a href="#" rel="consultantListTab" class="selected">Untouched Consultants List </a></li>
                                    <%} else {%>
                                    <li ><a href="#" rel="consultantSearchTab"> Untouched Consultants Search </a></li>
                                ...
                                <div  style="border:1px solid gray; width:830px;height: 500px; overflow:auto; margin-bottom: 1em;">
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <s:hidden name="activityFromDate" value="%{activityFromDate}"></s:hidden>
                                    ...
                                    <div id="consultantSearchTab" class="tabcontent"  >
                                        ...
                                        <s:form action="searchUntouchedConsultant" name="unTouchedConsultantsearchForm" theme="simple" onsubmit="return checkValidationForActivityDates()">
                                                    ...
                                                    <td>
                                                        ...
                                                        <table border="0" width="100%" cellpadding="1" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>  <s:select multiple="true" list="statesList"  name="locationList" id="locationList"  cssClass="inputSelectLarge"  value="%{locationList}" /></td>
                                                                <td class="fieldLabel">Work Authorization :</td>
                                                                <td colspan="3">                                                                    
                                                                    <s:select list="{'US Citizen','Green Card','EAD','H1','TN Permit Visa','Need H1B','Student Visa'}" name="workAuthorizationList" id="workAuthorizationList" value="%{workAuthorizationList}" cssClass="inputSelectLarge" multiple="true" size="4"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield id="AvailableFrom" name="availableFrom" cssClass="inputTextBlueLarge" value="%{availableFrom}" onchange="checkDates(this);" />
                                                                ...
                                                                <td>
                                                                    <s:textfield id="availableTo" name="availableTo" cssClass="inputTextBlueLarge" value="%{availableTo}" onchange="checkDates(this);"/>
                                                            ...
                                                            <tr>
                                                                <td class="fieldLabel">Created Between</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="fieldLabel">From Date:</td><td><s:textfield name="addedFromDate" id="addedFromDate" cssClass="inputTextBlueLarge"  onchange="checkDates(this);"/>
                                                                ...
                                                                <td class="fieldLabel">To Date:</td>
                                                                <td>
                                                                    <s:textfield name="addedToDate"  id="addedToDate" cssClass="inputTextBlueLarge"  onchange="checkDates(this);"/>
                                                            ...
                                                            <tr>
                                                                <td class="fieldLabel">Last Updated Between</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield id="titleTypeId" name="titleTypeId" value="%{titleTypeId}" cssClass="inputTextBlueLarge"/>
                                                                </td>
                                                            </tr>
                                                           <%-- <tr><td class="fieldLabel">Last Activity From</td></tr>  

                                                            <tr>
                                                                <td class="fieldLabel">From Date:<FONT color="red" SIZE="0.5"><em>*</em></FONT></td>

                                                                <td>
                                                                    <s:textfield id="activityFromDate1" name="activityFromDate" cssClass="inputTextBlueLarge" value="%{activityFromDate}" onchange="checkDates(this);" />
                                                                ...
                                                                <td>
                                                                    <s:textfield id="activityToDate" name="activityToDate" cssClass="inputTextBlueLarge" value="%{activityToDate}" onchange="checkDates(this);" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td > <s:textfield name="cellPhoneNo"  id="cellPhoneNo" value="%{cellPhoneNo}" cssClass="inputTextBlueLarge" onchange="return formatPhone(this);"/>
                                                                </td>
                                                                <td class="fieldLabel"></td>
                                                                <td style="padding-left:3px;"><input type="submit" value="Search" class="buttonBg"/>&nbsp;&nbsp;&nbsp;&nbsp;<s:reset cssClass="buttonBg" value="Reset" onclick="return untouchedResetvalues();"/></td>
                                                            </tr>
                                        ...
                                        <script type="text/JavaScript">
                                            ...
                                            var cal1 = new CalendarTime(document.forms['unTouchedConsultantsearchForm'].elements['availableFrom']);
                                            cal1.year_scroll = true;
                                            cal1.time_comp = false; 
                                            var cal2 = new CalendarTime(document.forms['unTouchedConsultantsearchForm'].elements['availableTo']);
                                            cal2.year_scroll = true;
                                            cal2.time_comp = false; 
                                            var cal3 = new CalendarTime(document.forms['unTouchedConsultantsearchForm'].elements['startDate']);
                                            cal3.year_scroll = true;
                                            cal3.time_comp = false;  
                                            var cal4 = new CalendarTime(document.forms['unTouchedConsultantsearchForm'].elements['endDate']);
                                            cal4.year_scroll = true;
                                            cal4.time_comp = false; 
                                           /* var cal5 = new CalendarTime(document.forms['unTouchedConsultantsearchForm'].elements['activityFromDate']);
                                            cal5.year_scroll = true;
                                            cal5.time_comp = false; 
                                            var cal6 = new CalendarTime(document.forms['unTouchedConsultantsearchForm'].elements['activityToDate']);
                                            cal6.year_scroll = true;
                                            cal6.time_comp = false; 
                                             */
                                            var cal7 = new CalendarTime(document.forms['unTouchedConsultantsearchForm'].elements['addedFromDate']);
                                            cal7.year_scroll = true;
                                            cal7.time_comp = false; 
        
        
                                            var cal8 = new CalendarTime(document.forms['unTouchedConsultantsearchForm'].elements['addedToDate']);
