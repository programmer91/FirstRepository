        ...
        <table class="templateTable1000x580" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                                                        ...
                                                        <td>
                                                                  <grd:dbgrid id="tblCrmAttachments" name="tblCrmAttachments" width="100" pageSize="18" 
                                                                   ...
                                                                   <%--  <grd:anchorcolumn dataField="Name" 
                                                                    ...
                                                                    <grd:anchorcolumn dataField="Name" 
                                                                                      headerText="Consultant Name" 
                                                                                      linkUrl="../consultant/reviewTechnical.action?name=jheDudcD&lee=djhgd343D&id={id}&consultantId={conId}&status={Status}&requirementId={RequirementId}&recConsultantId={RecConsultantId}" linkText="{Name}" width="20"/>

                                                                    <grd:textcolumn dataField="JobTitle"  headerText="Requirement Title"   width="10" sortable="true"/>  
                                                                    <grd:textcolumn dataField="Status"  headerText="Consultant Status"   width="10" sortable="true"/>  
                                                                    <grd:textcolumn dataField="Rateing"  headerText="Review Status"   width="10" sortable="true"/> 
                                                                    <grd:datecolumn dataField="ForwardedDate"  headerText="AssignedDate"  dataFormat="MM-dd-yyyy HH:mm:SS" width="15" sortable="true"/>
                                                                    <grd:datecolumn dataField="LastModifiedDate"  headerText="ReviewedDate"  dataFormat="MM-dd-yyyy HH:mm:SS" width="15" sortable="true"/>                 
                                                                </grd:dbgrid>
                    ...
                    <td > <s:select name="rateing" headerKey="" headerValue="--Please Select--" id="rateing" list="{'Not Yet Reviewed','Reviewed'}" cssClass="inputSelect" /></td>
                  ...
                  <%--  <td ><s:select id="status" name="status" headerKey="" headerValue="--Please Select--" list="{'Assigned','Forward','Reviewed','Reviewed&Forwarded'}" value="%{status}" cssClass="inputSelect"/></td> --%>
                    <td > <s:select headerKey="" headerValue="--Please Select--" name="status" id="status" list="{'Tech Screen shotlisted','Tech Screen Reject'}" cssClass="inputSelect" value="%{status}" /></td>
                ...
                <tr>
                  ...
                  <%--  <td ><s:select id="status" name="status" headerKey="" headerValue="--Please Select--" list="{'Assigned','Forward','Reviewed','Reviewed&Forwarded'}" value="%{status}" cssClass="inputSelect"/></td> --%>
                    <td > <s:select headerKey="" headerValue="--Please Select--" name="interveiwType" id="interveiwType" value="%{interveiwType}" list="{'Tech Screen  - Phone','Tech Screen  - Skype/F2F','Face to Face'}" cssClass="inputSelect" /></td>
