...
try{
    ...
    if(request.getAttribute("strSQL")!= null) {
        ...
        strSQL = "select Id,LName,FName,MName,Email2,CellPhoneNo from tblRecConsultant where CreatedBy='"+userId+"'";
    }
 //out.print(strSQL);
}catch(Exception ex) {
    ex.printStackTrace();
                                        ...
                                        <s:form method="post" 
                                            ...
                                            <grd:dbgrid id="tblDBGrid" 
                                                ...
                                                <grd:imagecolumn  headerText="View" 
                                                                  ...
                                                                  linkUrl="consultant/getConsultant.action?empId={Id}&requirement=-1&consultId=-1&requirementId=0&requirementAdminFlag=" 
                                                                  imageBorder="0"
                                                                  imageWidth="16" 
                                                                  imageHeight="16" 
                                                ...
                                                <grd:textcolumn dataField="Email2" headerText="E-Mail" width="18" HAlign="center" /> 
                                                <grd:textcolumn dataField="CellPhoneNo" headerText="Cell Number" width="12" HAlign="center" /> 
                                                <%--
