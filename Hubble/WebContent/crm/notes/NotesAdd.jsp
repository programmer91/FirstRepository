            ...
            <tr>
                <td valign="top" style="padding-left:10px;padding-top:5px;">
                    ...
                    <div  style="border:1px solid gray; width:840px;height: 230px; overflow:auto; margin-bottom: 1em;">
                        ...
                        <%--  <sx:div id="contactTab" label="Contact" theme="ajax" > --%>
                        <div id="contactTab" class="tabcontent"  >
                            <s:form name="noteForm" action="%{actionString}" theme="simple">
                                
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td class="headerText" colspan="2" align="right">
                                            <s:property value="#request.resultMessage"/>
                                            <a href="<s:url action="../contacts/getContact"><s:param name="id" value="%{objectId}"/></s:url>" style="align:center;">
                                            ...
                                            <s:hidden name="createdDate" value="%{currentNote.createdDate}"/>
                                            <s:hidden name="id" value="%{currentNote.id}"/>
                                            <s:hidden name="objectId" value="%{objectId}"/>
                                            <s:hidden name="objectType" value="%{objectType}"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="fieldLabel">NoteType:</td>
                                        <td >
                                            <s:select cssClass="inputSelect" name="noteType" id="noteType" list="noteTypeList" value="%{currentNote.noteType}"/>
                                            
                                        </td>
                                    </tr>
                                    <tr> 
                                        <td  class="fieldLabel" valign="top">Note:</td>
                                        <td> 
                                            <s:textarea id="note" name="note" cols="72" rows="8" value="%{currentNote.note}" onchange="noteValidate(document.noteForm.note.value);changeCase(this);" cssClass="inputTextarea"/>
...
countries.init()
            ...
            <td valign="top" style="padding-left:10px;padding-top:5px;">
                ...
                <div  style="border:1px solid gray; width:840px;height: 260px; overflow:auto; margin-bottom: 1em;">
                    ...
                    <div id="notes" class="tabcontent"  >
                        ...
                        queryString = queryString + " WHERE ObjectId ="+objectId;
                        queryString = queryString + " AND ObjectType = '"+objectType+"' ORDER BY CreatedDate";
