...
<html>
    <head>
        ...
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/calendar/weeklyEvents.js"/>"></script>
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/calendar/CalendarAjaxUtil.js"/>"></script>
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/calendar/Calendar.js"/>"></script>
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/calendar/EventPopupAjax.js"/>"></script>
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/calendar/CalendarAccess.js"/>"></script>
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/marketing/MarketingAjaxUtil.js"/>"></script>   
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/calendar/AccountTeam.js"/>"></script>   
...
//alert("which is first--2");
//alert("x--"+x);
//alert("y--"+y)
//alert("tx is--"+tx+"e.clientX--"+e.clientX+"x--"+x+"total--"+(tx+e.clientX-x))
//alert("ty is--"+ty+"e.clientY--"+e.clientY+"y--"+y+"total--"+(ty+e.clientY-y))
//alert("e.clientX--"+e.clientX);
  if( isdrag ) {
    dobj.style.left = nn6 ? tx + e.clientX -x: tx + event.clientX -x;
//    alert("left--"+dobj.style.left)
    dobj.style.top  = nn6 ? ty + e.clientY -y: ty + event.clientY-y;
//    alert("top--"+dobj.style.top)
    return false;
  }
}
        ...
        <table class="templateTableLogin" align="center" cellpadding="0" cellspacing="0" >
            ...
            <tr>
                        ...
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top">
                                ...
                                <sx:tabbedpanel id="Calendar" beforeSelectTabNotifyTopics="/accessCalUserList" cssStyle="width:850px; height:600px;padding-left:10px;padding-top:5px;" doLayout="true">
                                    ...
                                    <!--//START TAB : -->
                                    <sx:div id="calendarView" label="Calendar" cssStyle="overflow: auto;" >
                ...
                cal3.time_comp = false;
                                                    ...
                                                    <div id="displayWeeklyResult" style="display: none" >  
                                                        ...
                                                        <s:form name="addEventForm" id="addEventForm" action="" theme="simple" >
                                                            <table cellpadding="1"  cellspacing="1" border="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="fieldLabel"> Event Type: </td>   <!--eventTypeList-->                                                 
                                                                    <td><s:select list="{'Conference call','Correspondence','Demo','Email','Preparation','Presentation','Call - Outbound',
                                                                                      'Call - Outbound','Appointment'}" 
                                                                                      name="eventType"
                                                                                      id="eventType"
                                                                                      headerKey="-please select-"
