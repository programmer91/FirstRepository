<%-- 
    Document   : activitiesManagerDetails
    Created on : Oct 8, 2014, 6:54:31 AM
    Author     : miracle
--%>
...
<html>
    <head>
        <title>Hubble Organization Portal :: Activity Manager</title>
       ...
       <%-- <script type="text/JavaScript" src="<s:url value="/includes/javascripts/oppdashboardAjaxUtil.js"/>"></script> --%>
        ...
        <!-- new js -->
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/projectsValidations/ProjectTeamDashBoard.js"/>"></script>
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/EmployeeAjax.js"/>"></script>
        
         <script type="text/JavaScript" src="<s:url value="/includes/javascripts/activeManagerAjaxUtil.js"/>"></script>
                        ...
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding-left:10px;padding-top:5px;">
                                ...
                                <ul id="accountTabs" class="shadetabs" >
                                    <li><a href="#" rel="accountsListTab" class="selected"> Activity Manager DashBoard</a></li>
                                            ...
                                            <tr>
                                                <td class="homePortlet" valign="top">
                                                    <div class="portletTitleBar">
                                                        <div class="portletTitleLeft">Activity Manager</div>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%"> 
                                                            <tr>
                                                                <td width="40%" valign="top" align="center">
                                                                    <s:form action="" theme="simple" name="activitiesManagerDetails">  
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                        <tr>                                                    
                                                                                            ...
                                                                                            <td style="padding-left:0px;"><input id="normalUserButton" type="button" value="Search"  class="buttonBg"  onclick="getActiveManagerDetails();"/></td>         
                                                                                       </tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td >
                                                                                                ...
                                                                                                <div id="AccountSummaryByPriorityList" style="display: block">
                                                                                                    ...
                                                                                                    <table id="tblActivitiesManagerDetails" align='center' cellpadding='1' cellspacing='1' border='0' class="gridTable" width='700'>
                                                                                                        <COLGROUP ALIGN="left" >
                                                                                                            <COL width="5%">
                                                                                                            <COL width="25%">
                                                                                                            <COL width="10%">
                                                         ...
                                                         <script type="text/JavaScript">
                                                                        var calRep = new CalendarTime(document.forms['activitiesManagerDetails'].elements['startDate']);
                                                                        calRep.year_scroll = true;
                                                                        calRep.time_comp = false;
                                                                        calRep1 = new CalendarTime(document.forms['activitiesManagerDetails'].elements['endDate']);
