...
<head>
    ...
    <title>Hubble Organization Portal :: States Information</title>
            ...
            <td align="center">
                ...
                <s:form method="post" id="frmDBGrid" name="frmDBGrid" theme="simple"  action="">           
                    ...
                    <grd:dbgrid id="tblDBGrid" name="tblDBGrid" width="75" pageSize="20" 
                        ...
                        <grd:textcolumn dataField="Description" headerText="State" width="15" HAlign="center"/>
                        <grd:textcolumn dataField="Name" headerText="Name" width="15" HAlign="center" />
