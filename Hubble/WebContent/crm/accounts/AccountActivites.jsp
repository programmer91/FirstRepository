...
%>
        ...
        try{
             connection = ConnectionProvider.getInstance().getConnection();
              String a=session.getAttribute("Accid").toString();
        ...
        queryString = queryString + " WHERE AccountId ="+a+" AND ContactId =0 ORDER BY CreatedDate DESC";
