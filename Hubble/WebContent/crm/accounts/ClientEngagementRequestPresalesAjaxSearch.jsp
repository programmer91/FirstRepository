...
<html>
 ...
 <!--   <body class="bodyGeneral"   oncontextmenu="return false;" onload="getClientrequestDetailsForPresales('1','onload');"> -->
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="2" align="left" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="right" colspan="4">
                                                                        ...
                                                                        <input type="button" value="Search" class="buttonBg" onclick="getClientrequestDetailsForPresales('1','search');"/>
                                                            ...
                                                            <table width="100%" cellpadding="1" cellspacing="1" border="0">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <TABLE id="tblPSCERDetailsPresales" align="left"  
...
<script type="text/javascript">
		...
		getClientrequestDetailsForPresales('1','onload');
		});
		</script>
        <script type="text/javascript">
            ...
            function pagerOption(){
                ...
                $('#tblPSCERDetailsPresales').tablePaginate({navigateType:'navigator'},recordPage,tblPSCERDetailsPresales);
