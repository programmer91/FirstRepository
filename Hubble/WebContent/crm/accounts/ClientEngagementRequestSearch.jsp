...
.gridRowEvenPSCER
{
   ...
   <!-- <body class="bodyGeneral"   oncontextmenu="return false;" onload="getClientrequestDetailsForSales('1','onload');"> -->
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td></td>
                                                                     ...
                                                                     <td>
                                                                        ...
                                                                        <input type="button" value="Search" class="buttonBg" onclick="getClientrequestDetailsForSales('1','search');"/>
                                                                        
                                                                        <script type="text/javascript">
                                                                            function goToAddPage(){
                                                                                window.location='clientReqEngagementAdd.action';
                                                                            }
                                                                        </script>
                                                                        <input type="button" value="Add" class="buttonBg" onclick="goToAddPage();"/>
                                                            ...
                                                            <table width="100%" cellpadding="1" cellspacing="1" border="0">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <TABLE id="tblPSCERDetailsSales" align="left"  
...
<script type="text/javascript">
		...
		getClientrequestDetailsForSales('1','onload');
		});
		</script>
        ...
        <script type="text/javascript">
            ...
            function pagerOption(){
                ...
                $('#tblPSCERDetailsSales').tablePaginate({navigateType:'navigator'},recordPage,tblPSCERDetailsSales);
