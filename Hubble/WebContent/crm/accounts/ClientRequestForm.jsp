...
<html>
   ...
   <!--  <body class="bodyGeneral" oncontextmenu="return false;" onload="init1();loadAddressRow();requestSelect();"> -->
                                ...
                                <table align="center" border="0" cellspacing="0" style="width:100%;">
                                    ...
                                    <div id="libraryAdd" class="tabcontent"  >
                                                ...
                                                <tr align="right">
                                                    ...
                                                    <td class="headerText" colspan="4">
                                                        ...
                                                        <s:if test="#session.roleId == 10">
                                                              <a href="<s:url value="clientReqEngagementPreSalesSearch.action?backToFlag=Yes"/>" style="align:center;">
                                        ...
                                        &nbsp;&nbsp;
                                                        ...
                                                        <s:else>
                                                         <a href="<s:url value="clientReqEngagementSearch.action?backToFlag=Yes"/>" style="align:center;">
                                            <img alt="Back to List"
                                                 src="<s:url value="/includes/images/backToList_66x19.gif"/>" 
                                                 width="66px" 
                                                 height="19px"
...
<tr>
                                    ...
                                    <tr>
                                               ...
                                               <td class="fieldLabel" >RVP Region/ RVP Name:<FONT color="red"  ><em>*</em></FONT> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td > <s:textfield name="customerName" id="customerName" value="%{customerName}" cssClass="inputTextBlue"  theme="simple" onkeyup="fillCustomer();"/>
                                            ...
                                            <tr>
                                                   <%--  <td class="fieldLabel">Stage:<FONT color="red"  ><em>*</em></FONT></td>
                                                    ...
                                                    <td  align="left">
                                                       ...
                                                       <%if((session.getAttribute("title").toString().equals("BDE")&&session.getAttribute("roleName").toString().equals("Sales"))||(session.getAttribute("roleName").toString().equals("Pre-Sales")&&!request.getAttribute("bdmId").toString().equals("0"))){%>
                                                  
                                                
                                                     <td class="fieldLabel">BDM :</td>
                                                    <td colspan="3" align="left">
                                                            <s:select list="bdmMap" headerKey="0" headerValue="--Please Select--" name="bdmId" id="bdmId" value="%{bdmId}" cssClass="inputSelect"/> </td>
            ...
            />
                                                ...
                                                <s:if test="%{resourceMap.size!=0}"> 
                                                
                                                  <tr> <td class="fieldLabel forRemove">Resources :<FONT color="red"  ><em>*</em></FONT></td>
                                                    <td colspan="3">
...
<font color="green" size="2px"><b><s:property value="value"></s:property></b></font><br>
                                                ...
                                                <tr><td colspan="4" align="center">
                                                    ...
                                                    <s:if test="%{currentAction=='doClientReqEngagementAdd'}"> 
                                                        ...
                                                        <s:else>
                                                             ...
                                                             <s:if test="%{requestStage!='Approved'}"> 
                                                             ...
                                                             <s:if test="%{requestStage!='Approved' && requestStage!='Submitted'&& requestStage!='Reviewed'}"> 
                                                                 ...
                                                                 <input type="button" class="buttonBg" value="Submit" onclick="doRequestSubmit('Submitted');">
                                                             </s:if> 
                                                        </s:else> </s:if></td></tr>
                                            </table>
                                        </s:form>
   ...
   <script type="text/javascript" src="<s:url value="/includes/javascripts/reviews/jquery.js"/>"></script>  
        ...
        <link rel="stylesheet" type="text/css" href="<s:url value="/includes/css/StatusBar.css?version=2.3"/>">
		
		  
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/StatusBar.js?version=2.5"/>"></script> 
        </table>
