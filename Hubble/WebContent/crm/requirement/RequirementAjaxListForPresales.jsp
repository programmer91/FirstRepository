...
<script type="text/JavaScript" src="<s:url value="/includes/javascripts/PreSalesDashBoard.js?version=1.8"/>"></script>
        <s:include value="/includes/template/headerScript.html"/> 
    </head>
    <%-- <body class="bodyGeneral" oncontextmenu="return false;" onload="getRequirementsList1();"> --%>
   
       <!-- <body class="bodyGeneral" oncontextmenu="return false;" onload="getRequirementsListForPresalesMy();"> -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%--   <input type="button" value="Search" class="buttonBg" onclick="getSearchReqList();"/> --%>
                                                            ...
                                                            <input type="button" value="Search" class="buttonBg" onclick="getRequirementsListForPresalesMy();"/>
                                                    ...
                                                    <table width="100%" cellpadding="1" cellspacing="1" border="0">
                                                        ...
                                                        <tr>
                                                            <td colspan="3" >
                                                                ...
                                                                <table id="tblMyPreSalesRequirementList" cellpadding='1' cellspacing='1' border='0' class="gridTable" width='550' align="center">
...
<script type="text/javascript">
		...
		getRequirementsListForPresalesMy();
		});
		</script>
