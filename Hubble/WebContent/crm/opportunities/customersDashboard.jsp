<%-- 
    Document   : customersDashboard
    Created on : Apr 15, 2016, 4:56:00 PM
    Author     : miracle
--%>
...
<html>
    <head>
        ...
        <script language="JavaScript">
            animatedcollapse.addDiv('custDashboard', 'fade=1;persist=1;group=app');
                        ...
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding-left:10px;padding-top:5px;">
                                ...
                                <ul id="accountTabs" class="shadetabs" >
                                    <li><a href="#" rel="accountsListTab" class="selected">Opportunities</a></li>
                                                                ...
                                                                <td class="homePortlet" valign="top">
                                                                    <div class="portletTitleBar">
                                                                        ...
                                                                        <div class="portletIcons">
                                                                            <a href="javascript:animatedcollapse.hide('custDashboard')" title="Minimize">
                                                                                <img src="../../includes/images/portal/title_minimize.gif" alt="Minimize"/></a>
                                                                            <a href="javascript:animatedcollapse.show('custDashboard')" title="Maximize">
                                                                                <img src="../../includes/images/portal/title_maximize.gif" alt="Maximize"/>
                                                                            </a>
                                                                        </div>
                                                                        <div class="clear"></div>
                                                                    </div>
                                                                    <div id="custDashboard" style="background-color:#ffffff">
                                                                                                              ...
                                                                                                              <td  class="fieldLabel">State:&nbsp;</td>
                                                                                                                <td> 
                                                                                                                    <s:select name="state" id="state" cssClass="inputSelect" list="opportunityStateList" headerKey="" headerValue="All"/>
                                                                                                                            ...
                                                                                                                            <td class="fieldLabel">SVI Only:</td><td>
                                                                                                                             <s:checkbox id="svivalue" name="svivalue" checked="true"/>
                                                                                                                         </td>
                                                                                                                              <td>  </td>
                                                                                                                                 <td> 
                                                                                                                               <input type="button" id="opportunitySearchBUtton" class="buttonBg" onclick="getCustOpportunities()" value="Search"/>
                                                                                                                                 </td>
                                                                                                                             </tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td colspan="4" >
                                                                                                                            <lable id="noteLableForCustOpportunity" style="display:none;color:red;font-size: 80%; font-style: italic;">Note :The details are order by  Due date ascending.</lable>
                                                                                                                            <table id="tblOppCustmer" align="center"  
                                                                                                                                   cellpadding='1' cellspacing='1' border='0' class="gridTable" width='800'>
                                                                                                                                <COLGROUP ALIGN="left" >
                                                                                                                                    <COL width="5%">
                                                                                                                                    <COL width="15%">
                                                                                                                                    <COL width="20%">
