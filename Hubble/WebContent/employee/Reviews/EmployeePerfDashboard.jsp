<%-- 
    Document   : EmployeePerfDashboard
    Created on : Jun 19, 2015, 3:27:28 PM
    Author     : miracle
--%>
...
<html>
 ...
 <!--   <body class="bodyGeneral" onload="getEmployeeReviewDetails();" oncontextmenu="return false;"> -->
                                                                                    ...
                                                                                    <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                        <tr>                                                    
                                                                                            ...
                                                                                            <td><s:textfield name="startDate" id="startDate" cssClass="inputTextBlue" onchange="checkDates(this);"/> <a href="javascript:calRep.popup();">
                                                                                                    ...
                                                                                                    <td><s:hidden id="departmentId2" name="departmentId" value=""/>

                                                                                                        <s:textfield name="endDate" id="endDate" cssClass="inputTextBlue" onchange="checkDates(this);"/><a href="javascript:calRep1.popup();">
                                                                                                            <img  src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                                                                  width="20" height="20" border="0">  </td>
                                                                                            ...
                                                                                            <td><s:textfield name="startDate" id="personalRecordStartDate" cssClass="inputTextBlue" onchange="checkDates(this);"/> <a href="javascript:calper.popup();">
                                                                                                    ...
                                                                                                    <td><s:textfield name="endDate" id="personalRecordEndDate" cssClass="inputTextBlue" onchange="checkDates(this);"/><a href="javascript:calper1.popup();">
                                                                                                            ...
                                                                                                            <td class="fieldLabel">
                                                                                                                ...
                                                                                                                <s:else>
                                                                                                                    <td class="fieldLabel">
                                                                                                                <s:checkbox name="isManagerInclude" id="isManagerinclude" style="display:none;"></s:checkbox>
                                                                                                           </td> <td class="fieldLabelLeft">
                                                                                                            ...
                                                                                                            <td colspan="4" align="right">
                                                                                                                ...
                                                                                                                <input type="button" value="Search" class="buttonBg" onclick="getEmployeeReviewDetails();"/>
                                                                                                            </td> 
                                                                                                            </tr>
                                                                                                             <tr>
                                                                                            <td height="20px" align="center" colspan="9">
                                                                                                <div id="prloadingMessage" style="display:none" class="error" ><b>Loading Please Wait.....</b></div>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="rank"><s:property value="rank" /></label></td>
                                                                                                                <td class="fieldLabel">Score:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;"  id="score"><s:property value="score" /></label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td class="fieldLabel">Reporting Manager:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="reportingManager"><s:property value="reportingManager" /></label></td>
                                                                                                                <td class="fieldLabel">Reviews Submitted:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="reviewsSubmitted"><s:property value="reviewsSubmitted" /></label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td class="fieldLabel">Reviews Approved:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="reviewsApproved"><s:property value="reviewsApproved" /></label></td>
                                                                                                                <td class="fieldLabel">Reviews Pending:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="reviewsPending"><s:property value="reviewsPending" /></label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td class="fieldLabel">Reviews Rejected:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="reviewsRejected"><s:property value="reviewsRejected" /></label></td>
                                                                                                                <td class="fieldLabel">Review Approval Percentage:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="reviewApprovalPercentage"><s:property value="reviewApprovalPercentage" /></label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td class="fieldLabel">Lead Approved:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="leadApproved">0</label></td>
                                                                                                                <td class="fieldLabel">HR Approved:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="hrApproved">0</label></td>
                                                                                                          
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td class="fieldLabel">Lead Rejected:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="leadRejected">0</label></td>
                                                                                                                <td class="fieldLabel">HR Rejected:</td>
                                                                                                                <td class="fieldLabel"><label style="color:#FF0000;" id="hrRejected">0</label></td>
...
<tr>                                                    
                                                                                            ...
                                                                                            <td><s:textfield name="startDate" id="pastReviewStartDate" cssClass="inputTextBlue" onchange="checkDates(this);"/> <a href="javascript:calper.popup();">
                                                                                                    <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                                                         width="20" height="20" border="0"></td>    

                                                                                                    <td class="fieldLabel">EndDate</td>
                                                                                                    <td><s:textfield name="endDate" id="pastReviewEndDate" cssClass="inputTextBlue" onchange="checkDates(this);"/><a href="javascript:calper1.popup();">
                                                                                                            <img  src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                                                                  width="20" height="20" border="0">  </td>
                                                                                                            
                                                                                                           <td>
                                                                                                               &nbsp; &nbsp; &nbsp;
                                                                                                <input type="button"  value="Search" Class="buttonBg" onClick="getEmployeePastReviewData();"/>
