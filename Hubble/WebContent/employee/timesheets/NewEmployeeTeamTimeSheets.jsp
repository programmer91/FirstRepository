<%-- 
    Document   : NewEmployeeTeamTimeSheets
    Created on : Jan 27, 2015, 8:19:45 AM
    Author     : miracle
--%>
...
<html>
    ...
    <%
        ...
        if (request.getAttribute("currentEmpType") != null) {
            currentEmpType = request.getAttribute("currentEmpType").toString();
        }
    %>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="750px">
                                                ...
                                                <td align="center"> 
                                                    <table border="0" ><tr>
                                                            ...
                                                            <td><s:textfield name="startDate" cssClass="inputTextBlueSmall" value="%{startDate}"/><a class="underscore" href="javascript:cal1.popup();">
                                                            ...
                                                            <td>  <s:textfield name="endDate" cssClass="inputTextBlueSmall" value="%{endDate}" /><a class="underscore" href="javascript:cal2.popup();">
                                                                    <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" width="20" height="20" border="0"></a>
                                                            </td>
                                                            ...
                                                            <td class="fieldLabel">EmpType&nbsp;:</td>
                                                            ...
                                                            <td class="fieldLabel" id="teamTypeTd" >ReportsTo&nbsp;Level&nbsp;:</td>

                                                            <td id="teamTypeListTd" >  
                                                                <%-- <s:select list="#@java.util.LinkedHashMap@{'2':'All','0':'Lower Level','1':'Higher Level'}" id="teamType" name="teamType" cssClass="inputSelect" value="%{teamType}" onchange="getTeamByReportsToType(this);"/>
                                                                --%>
                                                                <s:select list="#@java.util.LinkedHashMap@{'0':'All','1':'Lower Level','2':'Higher Level'}" id="teamType" name="teamType" cssClass="inputSelect" value="%{teamType}" onchange="getTeamByReportsToType(this);"/>
                                                            </td>
                                                            <%--  <%} %> --%>
                                                            ...
                                                            <td class="fieldLabel" id="internalTeam">EmpName&nbsp;:</td>    
                                                            ...
                                                            <td> 
                                                                ...
                                                                <INPUT type="image"  onclick='document.teamSearch.action="newEmployeeteamTimeSheetsSearch.action"' src="<s:url value="/includes/images/go_21x21.gif"/>" >
                                                            </td>
                                                            <%--    <%} %> --%>
                                                            </tr>
                                                            <%--    <% if(session.getAttribute("empType").toString().equalsIgnoreCase("c")){%>
                                            ...
                                            <div id="displayResult">  
                                                <table align="center" cellpadding="0" cellspacing="0"  width="98%">
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <%-- <s:form method="post" id="frmDBGrid" name="frmDBGrid" theme="simple"  action="newteamTimeSheets.action">           --%>
                                                        <s:form method="post" id="frmDBGrid" name="frmDBGrid" theme="simple" action="newEmployeeteamTimeSheetsSearch.action">           
                                                            ...
                                                            dataMember="<%=strSQL%>" dataSource="<%=connection%>" cssClass="gridTable">
                                                                ...
                                                                <grd:datecolumn dataField="DateStart" headerText="Start Date" width="8" HAlign="right" dataFormat="MM-dd-yyyy" />
                                                                <grd:datecolumn dataField="DateEnd"	headerText="End Date" width="8" HAlign="right" dataFormat="MM-dd-yyyy"/>
                                                                <grd:numbercolumn dataField="TotalHrs" headerText="Billable Hrs" HAlign="right" dataFormat="   .0 " width="8" />
                                                                <grd:datecolumn dataField="SubmittedDate" headerText="Submitted Date" HAlign="right" width="10" dataFormat="MM-dd-yyyy"/>
                                        ...
                                        <td>
                                            <table cellpadding="1" cellspacing="2" border="0" width="100%">
                                                ...
                                                <s:form name="printEmpTimeSeet" action="#"  theme="simple" target="_blank">
                                                    ...
                                                    <td id="printTeamTypeListTd" style="display:none;">  
                                                        <%--  <s:select list="#@java.util.LinkedHashMap@{'2':'All','0':'Lower Level','1':'Higher Level'}" id="printTeamType" name="printTeamType" cssClass="inputSelect" value="%{printTeamType}" onchange="getPrintTeamByReportsToType(this);"/> --%>
                                                        <s:select list="#@java.util.LinkedHashMap@{'0':'All','1':'Lower Level','2':'Higher Level'}" id="printTeamType" name="printTeamType" cssClass="inputSelect" value="%{printTeamType}" />
                                                    ...
                                                    <td >
                                                        ...
                                                        <input type="button" class="buttonBg" value="Generate Excel" onclick="return getTeamTimesheetReport();" style="margin-left: 39px;"/>
                                                    </td>
                                                    </tr>
                                                </s:form>
