...
<head>
    ...
    <script type="text/JavaScript" src="<s:url value="/includes/javascripts/timesheets/EmpTimeSheetSerach.js?ver=1.0"/>"></script>
                       ...
                       // return false;
                         //   }else {
                              //   window.location="getEmpTimesheetReport.action?startdate="+fromDate+"&enddate="+toDate+"&employeeId="+empnameById+"&status="+status+"&projectId="+projectId;
                                 window.location="newGetEmpTimesheetReport.action?startdate="+fromDate+"&enddate="+toDate+"&employeeId="+empnameById+"&status="+status+"&projectId="+projectId+"&printTeamType="+printTeamType;
                          //  return true; 
                          //  }
                        ...
                        <table cellpadding="0" width="100%" cellspacing="0" bordercolor="#efefef">  
                            ...
                            <tr>
                                <td>
                                                ...
                                                <s:form name="teamSearch" action="newempTimeSheetSearch" theme="simple" >
                                    ...
                                    --%>
                                     <td class="fieldLabel" >Projects: </td>
                                        <td >
                                               <s:select list="projectMap" name="projectId" id="projectId" onchange="isSelectProject();isOprDualReportsTo(this);getEmployeesByProjectId('search');" headerKey="-1" headerValue="--Select Project--" cssClass="inputSelect" value="%{projectId}" disabled="false"/> 
                                        ...
                                        <td class="fieldLabel" id="teamTypeTd" style="display:none;">ReportsTo&nbsp;Level&nbsp;:</td>
                                                ...
                                                <tr>
                                                 ...
                                                 <td class="fieldLabel">Operation&nbsp;Contact:</td>
                                                    <td><s:select list="operationContactMapByCountry" id="opsContactId" name="opsContactId" headerKey="-1" headerValue="All" cssClass="inputSelectLarge" value="%{opsContactId}" />
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    %>
                                                        ...
                                                        <s:form method="post" id="frmDBGrid" name="frmDBGrid" theme="simple"  action="newempTimeSheetSearch.action">           
                            ...
                            <tr>
                                <td>
                                    ...
                                    --%>
                                     <td class="fieldLabel" >Projects: </td>
                                        <td >
                                               <s:select list="projectMap" name="projectId2" id="projectId2" onchange="isDualReportsTo(this);getEmployeesByProjectId('print');" headerKey="-1" headerValue="--Select Project--" cssClass="inputSelect" value="%{projectId2}" disabled="false"/> 
                                             <%--  <s:select list="{}" name="projectId" id="projectId" onchange="getEmployeesByProjectId();" headerKey="-1" headerValue="--Select Project--" cssClass="inputSelect" value="%{projectId}" disabled="false"/> --%>
                                        </td>
                                          ...
                                          <td class="fieldLabelLeft" id="printTeamTypeTd" style="display:none;">ReportsTo&nbsp;Level&nbsp;:</td>
                                                    ...
                                                    <td id="printTeamTypeListTd" style="display:none;">  <s:select list="#@java.util.LinkedHashMap@{'2':'All','0':'Lower Level','1':'Higher Level'}" id="printTeamType" name="printTeamType" cssClass="inputSelect"/></td>
                                                 </tr>
