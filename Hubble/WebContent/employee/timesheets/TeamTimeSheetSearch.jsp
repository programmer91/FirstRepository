                                        ...
                                        <table align="center" cellpadding="0" cellspacing="0"  width="98%">
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <s:else>
                                                        <s:form method="post" id="frmDBGrid" name="frmDBGrid" theme="simple"  action="teamTimeSheets.action">           
                                                            ...
                                                            <grd:dbgrid id="tblStat" name="tblStat" width="100" pageSize="10" 
                                                                ...
                                                                <grd:imagecolumn  headerText="Approve/Reject" width="10"  HAlign="center"  
                                                                                  imageSrc="../../includes/images/DBGrid/newEdit_17x18.png" 
                                                                                  linkUrl="getTeamTimeSheet.action?empID={EmpID}&timeSheetID={TimeSheetId}&resourceType={ResourceType}&projectId={ProjectId}" imageBorder="0" 
                                                                                  imageWidth="16" imageHeight="16" alterText="Click to edit" />
                                                                <grd:numbercolumn dataField="EmpName" headerText="EmpName" width="15" dataFormat=" "/>                  
                                                              <grd:textcolumn dataField="ProjectName" headerText="ProjectName" width="10" />
                                                                <grd:textcolumn dataField="Description" headerText="Status" width="6" />
                                        ...
                                        <tr>
                                            <td>
                                             ...
                                             <s:form name="printEmpTimeSeet" action="#"  theme="simple" target="_blank">
                                                    ...
                                                    <tr>
                                                        <td   class="fieldLabelLeft">Projects&nbsp;:</td>
                                                   <td ><s:select list="projectMap" id="projectId" name="projectId" headerKey="-1" headerValue="Internal" cssClass="inputSelectLarge" value="%{ProjectId}" onchange="getTeamByProjectId();"/></td> 
