...
<html>
    <head>
        ...
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/timesheets/MyTimesheets.js"/>"></script>
                                        ...
                                        <td style="padding: 5px 5px;">
                                            <s:if test="%{isOnsite != 'Onsite'}">
                                                <ul id="accountTabs" class="shadetabs" >
                                                    <li ><a href="#" class="selected" rel="timeSheetsListTab"  > TimeSheets </a></li>
                                                </ul>
                                                
                                                <%-- <sx:tabbedpanel  id="timeSheetsListPannel" cssStyle="width: 845px; height: 400px;padding: 5px 5px;" doLayout="true"> --%>
                                                
                                                <div  style="border:1px solid gray; width:845px;height: 371px; overflow:auto; margin-bottom: 1em;">
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0" width="600px">
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <s:form name="search" action="newtimeSheet.action" theme="simple" method="post" onsubmit="return (validateDates() && compareDates(document.getElementById('startDate').value,document.getElementById('endDate').value));">
                                                                                    <td class="fieldLabel">Start&nbsp;Date&nbsp;(mm/dd/yyyy)&nbsp;:</td>
                                                                                    <td><s:textfield name="startDate" id="startDate" cssClass="inputTextBlueSmall"  value="%{startDate}"  onchange="isValidDate(this)"/><a class="underscore" href="javascript:cal1.popup();">
                                                                                    ...
                                                                                    <td>  <s:textfield name="endDate" id="endDate" cssClass="inputTextBlueSmall"  value="%{endDate}"  onchange="isValidDate(this)"/><a class="underscore" href="javascript:cal2.popup();">
                                                                                        <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" width="20" height="20" border="0"></a>
                                                                                    </td>
                                                                                   <%-- <td> <INPUT type="image"  onclick='document.search.action="./TimeSheetSearch.jsp"' src="<s:url value="/includes/images/go_21x21.gif"/>" >
                                                                                    </td> --%>
                                                                              <%--     <td> <INPUT type="image"  onclick='document.search.action="newtimeSheet.action"' src="<s:url value="/includes/images/go_21x21.gif"/>" ></td>  --%>
                                                                              <td> <INPUT type="submit" class="buttonBg" value="Search"></td>
                                                                                </s:form>
                                                                                ...
                                                                                <td align="center">
                                                                                   ...
                                                                                   //     System.out.println("The First");
                                                                                       ...
                                                                                       if(empType.equalsIgnoreCase("e")){
                                                                                        ...
                                                                                        strSQL="SELECT * from vwNewTimeSheetList WHERE EmpId="+empId;
                                                                                       }else{
                                                                                        empId = (String)request.getSession(false).getAttribute(ApplicationConstants.SESSION_CUST_ID);
                                                                                        //out.println(empId);
                                                                                        strSQL="SELECT * from vwNewCustTimeSheetList WHERE EmpId="+empId;
                                                                                      ...
                                                                                      //  System.out.println(strSQL);
                                                                                        ...
                                                                                        //out.println(request.getSession().getAttribute("Empquery").toString());
                                                                                    ...
                                                                                    <s:form method="post" id="frmDBGrid" name="frmDBGrid" theme="simple"  action="">           
                                                                                        ...
                                                                                        <grd:dbgrid id="tblStat" name="tblStat" width="100" pageSize="10" 
                                                                                          ...
                                                                                          <%--  <grd:imagecolumn  headerText="Edit" width="5"  HAlign="center"  imageSrc="../../includes/images/DBGrid/newEdit_17x18.png" linkUrl="newgetTimesheet.action?empID={empID}&timeSheetID={TimeSheetId}&resourceType={ResourceType}&statusValue={Description}" imageBorder="0" imageWidth="16" imageHeight="16" alterText="Click to edit" /> --%>
                                                                                          
                                                                                        <grd:imagecolumn  headerText="Edit" width="5"  HAlign="center"  imageSrc="../../includes/images/DBGrid/newEdit_17x18.png" linkUrl="newgetTimesheet.action?empID={empID}&timeSheetID={TimeSheetId}&resourceType={ResourceType}&statusValue={Description}&secStatusValue={SecDescription}" imageBorder="0" imageWidth="16" imageHeight="16" alterText="Click to edit" />
                                                                                      ...
                                                                                      linkText="Click To View"  width="10" />
                                                                                          ...
                                                                                          <%--   <grd:textcolumn dataField="ProjectName" headerText="ProjectName" width="10" /> 
                                                                                            ...
                                                                                            <grd:datecolumn dataField="DateStart" headerText="Start Date" width="10" dataFormat="MM-dd-yyyy" HAlign="right"/>
                                                                                            <grd:datecolumn dataField="DateEnd"	headerText="End Date" width="10" dataFormat="MM-dd-yyyy" HAlign="right"/>
                                                                                            <grd:numbercolumn dataField="TotalHrs" headerText="Billable Hrs" dataFormat="   .0 " width="8" HAlign="right"/>
                                                                                            <grd:datecolumn dataField="SubmittedDate" headerText="Submitted Date" width="10" dataFormat="MM-dd-yyyy" HAlign="right"/>
                                                                                            <grd:datecolumn dataField="ApprovedDate" headerText="Approved Date" width="10" dataFormat="MM-dd-yyyy" HAlign="right"/> 
                                                                                            <grd:imagecolumn headerText="Delete" width="4" HAlign="center" 
                                                                                                             imageSrc="../../includes/images/DBGrid/Delete.png"
                                                                                                             linkUrl="newDeleteTimeSheet.action?Id={Id}&empID={empID}&timeSheetID={TimeSheetId}" imageBorder="0"
                                                                ...
                                                                <td>
                                                                    <table cellpadding="0" cellspacing="0" border="0" width="600px">
                                                                        <tr>
                                                                            <td>
                                                                                <!-- We have to implement Search login in backend-->
                                                                                <s:form name="search" action="timeSheet.action" theme="simple">
                                                                                    <td class="fieldLabel">Start Date  (mm/dd/yyyy):</td>
                                                                                    <td><s:textfield name="startDate" placeholder="Start Date" cssClass="inputTextBlueSmall" value="%{startDate}" onchange="isValidDate(this)"/><a class="underscore" href="javascript:cal1.popup();">
                                                                                        <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" width="20" height="20" border="0"></a>
                                                                                    </td>
                                                                                    
                                                                                    <td class="fieldLabel">End Date  (mm/dd/yyyy):</td>
                                                                                    <td>  <s:textfield name="endDate" placeholder="End Date" cssClass="inputTextBlueSmall" value="%{endDate}" onchange="isValidDate(this)"/><a class="underscore" href="javascript:cal2.popup();">
                                                                                        <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" width="20" height="20" border="0"></a>
                                                                                    </td>
                                            ...
                                            <div  style="border:1px solid gray; width:845px;height: 250px; overflow:auto; margin-bottom: 1em;">
                                                <s:if test="%{isOnsite != 'Onsite'}">
                                                    ...
                                                    <div id="timeSheetsAddTab" class="tabcontent"  >
                                                        <s:form name="timeSheetSubmit" id="timeSheetSubmit" action="newfillTimesheet" theme="simple" onsubmit="return checkDateForTimesheet();"> <!--action="employee" -->
                                                                    ...
                                                                    <td>
                                                                        <table cellpadding="1" cellspacing="1" align="center" width="400px" class="cellBorder">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <font color="blue" size="2">Previous week starting on :</font>&nbsp;<s:textfield id="previousWeek" name="previousWeek" cssClass="inputTextBlueSmall" onchange="isValidDate(this)"/><a class="underscore" href="javascript:cal3.popup();">
                                                                                    <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" width="20" height="20" border="0"></a>
                                                                                </td>
                                                                                <%--<td>
