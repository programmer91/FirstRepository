...
<html>
    <head>
        <title>Hubble Organization Portal :: My GDC Team</title>
         <sx:head cache="true"/>
                    ...
                    <table class="innerTableLogin" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top">
                                ...
                                <!--//START TABBED PANNEL : -->
                                    <sx:tabbedpanel id="test" cssStyle="width: 845px; height: 550px;padding-left:10px;padding-top:5px;" doLayout="true">
                                    <!--//START TAB : -->
                                    <sx:div id="myTeamTab" label="Team Hierarchy" cssStyle="overflow:auto;" >
