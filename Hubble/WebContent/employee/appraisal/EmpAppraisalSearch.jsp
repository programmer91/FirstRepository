...
<html>
    <head>
        <title>Hubble Organization Portal :: Employee Appraisal Search</title>
        <sx:head cache="true"/>
        ...
        <%--<script type="text/JavaScript" src="<s:url value="/includes/javascripts/EmpAppraisal.js"/>"></script>--%>
                        ...
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top">
                                ...
                                <sx:tabbedpanel id="employeeSearchPannel" cssStyle="width: 840px; height: 500px;padding: 5px 5px 5px 5px;" doLayout="true">
                                    ...
                                    <!--//START TAB : -->
                                    <sx:div id="employeeSearchTab" label="Employee Appraisal Search" cssStyle="overflow: auto;">
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <s:form name="frmEmpSearch" action="/employee/appraisal/getAppraisalQuery.action" theme="simple">     
                                                        <table cellpadding="1" cellspacing="1" border="0" width="600px">
                                                            
                                                            <tr> 
                                                                <td class="fieldLabel">Name :</td>
                                                                <td><s:textfield name="firstName" id="firstName" cssClass="inputTextBlue" value="%{firstName}" onchange="fieldLengthValidator(this);"/> </td>
                                                                ...
                                                                <td><s:textfield name="workPhoneNo" id="workPhoneNo" cssClass="inputTextBlue" value="%{workPhoneNo}" onchange="return formatPhone(this);" onblur="return validatenumber(this)"/></td> 
                                                            </tr>
                                                            <tr>
                                                                <td  class="fieldLabel">Current Status:</td>
                                                                <td><s:select list="currStatusList" id="currStatus" name="currStatus" headerKey="All"  headerValue="All" cssClass="inputSelect" value="%{currStatus}"/></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><s:select label="Select Practice Name" 
                                                                                  ...
                                                                                  headerKey=""
                                                                                  headerValue="-- Please Select --"
                                                                              list="practiceIdList" cssClass="inputSelect" value="%{practiceId}" onchange="getSubPracticeData();"/> <%--onchange="getTeamData();" --%></td> 
                                                                <td class="fieldLabel" width="200px" align="right">SubPractice Name :</td>
                                                                
                                                                <td><s:select name="subPractice"  id="subPractice"
                                                                                  headerKey=""
                                                                                  headerValue="-- Please Select --"
                                                                              list="subPracticeList" cssClass="inputSelect" value="%{subPractice}" onchange="getTeamData();"/></td>  
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><s:select label="Select Team Name" 
                                                                                  ...
                                                                                  headerKey=""
                                                                                  headerValue="-- Please Select --"
                                                                              list="teamIdList" cssClass="inputSelect" value="%{currentEmployee.teamId}"/></td>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                            ...
                                                            <tr>
                                                                <td width="100%">
                                                                    ...
                                                                    <grd:dbgrid id="tblStat" name="tblStat" width="98" pageSize="19"
