 ...
 *
 * $Header: /Hubble/Hubble_CVS/Hubble/web/employee/projects/EmpMapIssueList.jsp,v 1.2 2009-03-31 10:48:48 hkondala Exp $
 *
 * $Id: EmpMapIssueList.jsp,v 1.2 2009-03-31 10:48:48 hkondala Exp $
 *
 * $Log: EmpMapIssueList.jsp,v $
 ...
 * $Revision: 1.2 $
 *
 * $Source: /Hubble/Hubble_CVS/Hubble/web/employee/projects/EmpMapIssueList.jsp,v $  
 *
                                    ...
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <sx:tabbedpanel id="accountPannel" cssStyle="width: 840px; height: 280px;padding-left:10px;padding-top:5px;" doLayout="true">
                                                ...
                                                <!--//START TAB : -->
                                                <sx:div id="accountTab" label="Map Details" >
                                                    <s:form name="frmMapEdit" action="" theme="simple">
                                                ...
                                                out.println(request.getAttribute(ApplicationConstants.RESULT_MSG));
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><s:textfield name="mapName" cssClass="inputTextBlueLarge" value="%{currentMapProject.mapName}" onchange="mapNameValidate(document.frmMapEdit.mapName.value);" readonly="true"/></td> 
                                                                
                                                                <td class="fieldLabel">Current State :</td>                                                                                                                    
                                                                <td><s:select list="mapStatusTypeList" name="currentState" cssClass="inputSelect" headerKey="" headerValue="--Please Select--" value="%{currentMapProject.currentState}" disabled="true"/></td>
                                                                <%--
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><s:textfield name="startDate" cssClass="inputTextBlueSmall" value="%{currentMapProject.startDateOne}" disabled="true"/><a href="javascript:cal1.popup();">
                                                                ...
                                                                <td><s:textfield name="endDate" cssClass="inputTextBlueSmall"  value="%{currentMapProject.endDateOne}" disabled="true"/><a href="javascript:cal2.popup();">
                                                                    <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" width="20" height="20" border="0"></a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td><s:textfield name="bussinessDomain" cssClass="inputTextarea" value="%{currentMapProject.bussinessDomain}" onchange="bussinessDomainValidate(document.frmMapEdit.bussinessDomain.value);" readonly="true"/></td> 
                                                                
                                                                <td class="fieldLabel">Tool :</td>                                                    
                                                                <td><s:select list="toolsListMaps" name="mapTools" value="%{currentMapProject.tool}" cssClass="inputSelect" disabled="true"/></td>
                                                                
                                                            </tr>
                                                            <tr>
                                                                
                                                                <td class="fieldLabel">Project Manager :</td>                                                    
                                                                <td><s:select list="projectManagerLists" name="projectManager" value="%{currentMapProject.projectManager}" cssClass="inputSelectLarge" disabled="true"/></td>
                                                                
                                                                <td class="fieldLabel">Tech Lead :</td>
                                                                <td><s:select list="techLeadMaps" name="techLead" value="%{currentMapProject.techLead}"  cssClass="inputSelectLarge" disabled="true"/></td> 
                                                            </tr>
                                                            
                                                            <tr>
                                                                
                                                                <td class="fieldLabel">Mapper :</td>
                                                                <td><s:select name="mapper" list="mapperMaps" value="%{currentMapProject.mapper}"  cssClass="inputSelectLarge" disabled="true"/></td> 
                                                                
                                                                <td class="fieldLabel">Tester:</td>                                                    
                                                                <td><s:select name="tester" list="testerMaps" value="%{currentMapProject.tester}"  cssClass="inputSelectLarge" disabled="true"/></td>
                                                                
                                                            </tr>
                                                            <tr>
                                                                <td class="fieldLabel">Descrption :</td>
                                                                <td colspan="3" ><s:textarea cssClass="inputTextarea" rows="2" cols="83" name="description" value="%{currentMapProject.description}" onchange="descriptionValidate(document.frmMapEdit.description.value);" readonly="true"/></td>                                                    
                                            ...
                                            <!--//START TABBED PANNEL : --> 
                                            <sx:tabbedpanel id="accountListPannel" cssStyle="width: 840px; height: 220px;padding-left:10px;padding-top:5px;" doLayout="true">
                                            ...
                                            <%--
                                                <s:if test="#session.roleName == 'Admin'">
                                                    <!--//START TAB : -->
                                                    <s:div id="accountsListTab" label="Issues List" theme="ajax" >
