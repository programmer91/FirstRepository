...
<html>
    <head>
        ...
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/employee/totalLeaves.js"/>"></script>
                                                    ...
                                                    <td>
                                                        <table align="center" border="0" width="80%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td><input type="text" name="year" autocomplete="off" maxlength="4"  id="year" class="inputTextBlue" onkeyup="load(event);"/></td>
