<%-- 
    Document   : SetMcertExam
    Created on : Jun 30, 2016, 10:29:17 PM
    Author     : miracle
--%>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:5px 5px;">
                                ...
                                <%--    <% if(request.getParameter("issueList")==null)
                                       {%> --%>
                                        ...
                                        <li ><a href="#" class="selected" rel="creConsultantList">Mcert Consultant Exam </a></li>
                                   ...
                                   <%--  <% if(request.getParameter("issueList")==null)
                                    ...
                                    <div id="creConsultantList" class="tabcontent"  >
                                        ...
                                        try{
                                            ...
                                            String practiceAction = "addMcertExamDetails.action";
                                                ...
                                                <table cellpadding="0" border="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <grd:dbgrid id="tblMcertSetExam" name="tblMcertSetExam" width="100" pageSize="18" 
                                                                    ...
                                                                    <grd:imagecolumn  headerText="SubTopic Edit" width="3"  HAlign="center" 
                                                                              ...
                                                                              linkUrl="getMcertExamDetails.action?subtopicId1={Id}" 
                                                                    ...
                                                                    <grd:imagecolumn  headerText="Inactive" width="3"  HAlign="center" 
                                                                              ...
                                                                              linkUrl="inActiveMcertExam.action?subtopicId1={Id}" 
