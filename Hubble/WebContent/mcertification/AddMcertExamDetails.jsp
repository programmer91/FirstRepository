                        ...
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:10px 5px 5px 5px;">
                                <ul id="accountTabs" class="shadetabs" >
                                    <li><a href="#" class="selected" rel="getCreRecords">Set Mcert Exam</a></li>
                                      ...
                                      <table align="center" border="0" cellpadding="1" cellspacing="1">
                                          ...
                                          <tr>
                                              <td>
                                                  <div id="examDetails">
                                                      <table border="0">
                                                          ...
                                                          <tr> <td class="fieldLabel">ExamType :<font color="red">*</font></td>
                                                              ...
                                                              <td> <s:if test="%{currentAction == 'doAddMcertSubTopics'}">
                                                          ...
                                                          <tr><td class="fieldLabel" rowspan="4">SubTopics:<font color="red">*</font></td>
                                                             <td rowspan="4"><s:select name="subtopics1" id="subtopics" value="subtopics1" cssClass="inputSelect" list="mcertTopicsMap" size="6" multiple="true" onchange="resetNoOfQuest();"></s:select></td> 
                                                ...
                                                <s:if test="%{currentAction == 'doAddMcertSubTopics'}">
