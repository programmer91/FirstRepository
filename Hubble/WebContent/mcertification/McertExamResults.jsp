    ...
    <head>
        ...
        <script type="text/javascript">
            function init1() {
                ...
                var insflag =  document.getElementById("insSearchFlag").value;
                                    ...
                                    <div id="issuesTab" class="tabcontent"  >
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                queryString = session.getAttribute(ApplicationConstants.MCERT_MY_EXAM_RESULT_QUERY).toString();
...
linkUrl="javascript:getCandidateName('{empId}','{TopicName}');" linkText="{empId}" width="20"/>--%>
                                                                ...
                                                                <grd:textcolumn dataField="empId"  headerText="ConsultantId"   width="20" sortable="true"/> 
                                                                <%-- <grd:textcolumn dataField="TopicName"  headerText="Exam Name"   width="10" sortable="true"/> --%>
                                                  <grd:textcolumn dataField="NAME"    headerText="ConsultantName"   width="15" />

                                                                <grd:textcolumn dataField="examType"    headerText="ExamName"   width="15" />

                                                                <%-- <grd:datecolumn dataField="DateSubmitted"  headerText="Date Taken"  dataFormat="MM-dd-yyyy HH:mm:SS" width="15" sortable="true"/>--%>

                                                                <grd:datecolumn dataField="DateSubmitted"  headerText="DateTaken"  dataFormat="MM-dd-yyyy" width="15" sortable="true"/>

                                                                <grd:numbercolumn dataField="TotalQuestions"  headerText="TotalQues" width="6"   dataFormat=""/> 
                                                                <grd:numbercolumn dataField="AttemptedQuestions"  headerText="AttemptedQues"   width="6"  dataFormat=""/> 
                                                                ...
                                                                <grd:imagecolumn  headerText="Reivew" width="5"  HAlign="center"  
                                                                                  ...
                                                                                  linkUrl="reviewMcertExam.action?examKeyId={ExamKeyId}" 
                                            ...
                                            <table border="0" cellpadding="1" cellspacing="1" width="100%">
                                                ...
                                                <tr><td align="center"> <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="40%"><s:textfield name="startDate" value="%{startDate}" id="startDate" cssClass="inputTextBlue"/><a class="underscore" href="javascript:cal1.popup();">
                                                                        <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                             width="20" height="20" border="0"></a></td>
                                                                <td class="fieldLabel">End Date:</td>
                                                                <td><s:textfield name="endDate" id="endDate" value="%{endDate}" cssClass="inputTextBlue"/><a class="underscore" href="javascript:cal2.popup();">
                                                                        <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                             width="20" height="20" border="0"></a></td>

                                                                <td></td>
                                                                <td class="headerText" align="right">
                                                        <s:hidden name="insSearchFlag" id="insSearchFlag"  cssClass="inputTextBlue"  value="%{insSearchFlag}"  theme="simple"/>
                                                                ...
                                                                <s:if test="%{currentAction == 'searchExamResultList'}">
                                                                    ...
                                                                    <td>
                                                                        <s:select headerKey="" headerValue="--select--" list="#@java.util.LinkedHashMap@{'1':'Employee', '2':'Consultant'}" name="empType" 
                                                                                  value="%{empType}" cssClass="inputSelect" id="empType" onchange="fieldVisable();" onblur="fieldVisable();"/>
                                                                    </td>
